...
//	private QueryState query_bench_ro_2;
...
//			query_bench_ro_2 = world.query(WorldQuery.builder().read_component(TestingI.class).read_component(TestingS.class));
...
//
//	@Benchmark
//	public void table_for_each_ro_2(Blackhole blackhole) throws Exception {
//		query_bench_ro_2.for_each((Object[] things) -> {
//			blackhole.consume(((TestingI) things[0]).value);
//			blackhole.consume(((TestingS) things[1]).value);
//		});
//	}
//
//	@Benchmark
//	@SuppressWarnings("unchecked")
//	public void table_for_each_packed_ro_2(Blackhole blackhole) throws Exception {
//		query_bench_ro_2.for_each_packed((Object[] things) -> {
//			ArrayList<TestingI> packedI = (ArrayList<TestingI>) things[0];
//			ArrayList<TestingS> packedS = (ArrayList<TestingS>) things[1];
//			var iterS = packedS.iterator();
//			for (Object thing : packedI) {
//				iterS.hasNext(); // Ignored return, packedS is same length as packedI
//				blackhole.consume(thing);
//				blackhole.consume(iterS.next());
//			}
//		});
//	}
//
